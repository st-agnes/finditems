...
class TimeDuration implements ModelInterface, ArrayAccess
{
     ...
     * Sets value
     *
     * @param int $value Retrieves the duration of the time span (no units).The value in this field indicates the number of years, months, days, hours, or minutes in the defined period.
     *
     * @return $this
     */
