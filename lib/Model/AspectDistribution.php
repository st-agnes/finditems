...
class AspectDistribution implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'aspect_value_distributions' => '\Swagger\Client\Model\AspectValueDistribution[]',
     ...
     *
     * @return \Swagger\Client\Model\AspectValueDistribution[]
     */
     ...
     *
     * @param \Swagger\Client\Model\AspectValueDistribution[] $aspect_value_distributions An array of containers for the various values of the aspect and the match count and a HATEOAS reference ( refinementHref) for this aspect.
     *
     * @return $this
     */
     ...
     *
     * @param string $localized_aspect_name Name of an aspect, such as Brand, Color, etc.
     *
     * @return $this
     */
