...
class ConditionDistribution implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionDistribution';
     ...
     * Sets condition
     *
     * @param string $condition The name of the condition, such as New or Used
     *
     * @return $this
     */
     ...
     * Sets match_count
     *
     * @param int $match_count The number of items having the condition.
     *
     * @return $this
     */
     ...
     *
     * @param string $refinement_href The HATEOAS reference of this condition.
     *
     * @return $this
     */
