...
class LegalAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LegalAddress';
     ...
     * Sets country
     *
     * @param string $country The three-letter ISO 3166-1 standard of the country of the address. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/browse/types/CountryCodeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets country_name
     *
     * @param string $country_name The name of the country of the address.
     *
     * @return $this
     */
     ...
     * Sets county
     *
     * @param string $county The name of the county of the address.
     *
     * @return $this
     */
