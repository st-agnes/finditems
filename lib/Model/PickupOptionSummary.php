...
class PickupOptionSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PickupOptionSummary';
     ...
     *
     * @param string $pickup_location_type This container returns the local pickup options available to the buyer. Possible values are ARRANGED_LOCATION and STORE.
     *
     * @return $this
     */
